...
function showModal(titleStr, contentStr, buttonTxt, callback) {
    ...
    var title = DCE("div");
    title.className = "groupboxtitle";
    title.style.textAlign = "center";
    title.innerHTML = titleStr;
    var num = DCE("div");
    num.className = "groupboxnum hidden";
    if (modalStack.length > 0) {
        num.className = "groupboxnum";
        num.innerText = modalStack.length + 1;
    }
    title.appendChild(num);
    var content = DCE("div");
    content.className = "modalbody";
    content.innerHTML = contentStr;
    var buttons = DCE("div");
    buttons.className = "modalbuttonbar";
    if (!buttonTxt)
        buttonTxt = ["OK"];
